...
<head runat="server">
  ...
  <title>TuYaque - Incidencias/Información</title>
  <!-- Favicon-->
...
<body id="page-top">
  ...
  <form id="form1" runat="server">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">TuYaque</a>
        ...
        <div class="row">
          <p class="lead">
            TuYaque es una iniciativa centrada en la elaboración de portales digitales, que permitirán a la población en
              general reportar distintos tipos de incidencias que podrían estar ocurriendo sobre la cuenca del
              río Yaque del Norte.
          </p>
        </div>
      </div>
  ...
  <script src="assets/reporta/reporta.js"></script>
  <!-- Core theme JS-->
